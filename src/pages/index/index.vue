...
export default {
  data () {
    return {
      ...
      top: [],
      imgUrls: [
        'cloud://pure-709fe2.7075-pure-709fe2/swiper 图片/1.jpeg',
        'cloud://pure-709fe2.7075-pure-709fe2/swiper 图片/2.jpeg',
        'cloud://pure-709fe2.7075-pure-709fe2/swiper 图片/3.jpeg',
      ],
      indicatorDots: false,
      autoplay: false,
      interval: 5000,
